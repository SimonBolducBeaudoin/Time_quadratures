...
#define PY_TIME_QUAD_FFT(FloatType, DataType)                                                                \
    py::class_<TimeQuad_FFT<FloatType, DataType>>(m, "TimeQuad_FFT_" #FloatType "_" #DataType, s_TQ)         \
        .def(py::init<np_double, np_int16, double, uint, int>(), "ks"_a.noconvert(), "data"_a.noconvert(),   \
             "dt"_a.noconvert(), "l_fft"_a.noconvert(), "n_threads"_a.noconvert())                           \
...
#define PY_TIME_QUAD_FFT_TO_HIST(FloatType, BinType, DataType)                                               \
    py::class_<TimeQuad_FFT_to_Hist<FloatType, BinType, DataType>>(                                          \
        ...
        .def(py::init<np_double, np_int16, double, uint, uint, double, int>(), "ks"_a.noconvert(),           \
             "data"_a.noconvert(), "dt"_a.noconvert(), "l_fft"_a.noconvert(), "nb_of_bins"_a.noconvert(),    \
