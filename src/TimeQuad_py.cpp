...
const char *s_TQ = "\t TimeQuad_FFT implements an fft convolutions algorithm parallelized "
                   "with openmp.\n"
...
const char *s_TQtoH = "\t TimeQuad_FFTtoHist implements an fft convolutions followed by a "
