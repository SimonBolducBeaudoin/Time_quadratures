...
template <class FloatType, class BinType, class DataType> class TimeQuad_FFT_to_Hist {
...
template <class BinType, class DataType> class TimeQuad_FFT_to_Hist<double, BinType, DataType> {
  public:
    // Contructor
    TimeQuad_FFT_to_Hist(np_double ks, py::array_t<DataType, py::array::c_style> data, double dt, uint l_fft,
...
template <class BinType, class DataType> class TimeQuad_FFT_to_Hist<float, BinType, DataType> {
  public:
    // Contructor
    TimeQuad_FFT_to_Hist(np_double ks, py::array_t<DataType, py::array::c_style> data, float dt, uint l_fft,
                         uint nofbins, double max, int n_threads);
    // Destructor
    ~TimeQuad_FFT_to_Hist();
