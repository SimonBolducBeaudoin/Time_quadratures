...
template <class BinType, class DataType>
uint TimeQuad_FFT_to_Hist2D<float, BinType, DataType>::compute_n_prod(
    np_double &np_array) {
...
TimeQuad_FFT_to_Hist2D<float, BinType, DataType>::copy_ks(np_double &np_ks,
                                                          uint n_prod) {
...
template <class BinType, class DataType>
uint TimeQuad_FFT_to_Hist2D<float, BinType, DataType>::compute_l_kernels(
    np_double &np_array) {
  py::buffer_info buffer = np_array.request();
  std::vector<ssize_t> shape = buffer.shape;
...
template <class BinType, class DataType>
std::vector<ssize_t>
TimeQuad_FFT_to_Hist2D<float, BinType, DataType>::get_shape(
    np_double &np_array) {
...
template <class BinType, class DataType>
void TimeQuad_FFT_to_Hist2D<float, BinType, DataType>::prepare_kernels(
    np_double &np_ks) {
...
template <class BinType, class DataType>
py::array_t<double>
TimeQuad_FFT_to_Hist2D<float, BinType, DataType>::abscisse_py(double max,
                                                              uint nofbins) {
