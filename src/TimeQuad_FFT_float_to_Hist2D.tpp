...
TimeQuad_FFT_to_Hist2D<float, BinType, DataType>::TimeQuad_FFT_to_Hist2D(
    ...
    : n_prod(compute_n_prod(ks)), n_hist(std::max(n_prod / 2, (uint)1)), ks_shape(get_shape(ks)),
      ...
      l_qs_chunk(l_kernel - 1), ks(copy_ks(ks, n_prod)), quads(Multi_array<float, 2>(n_prod, l_qs)),
...
// CHECKS
template <class BinType, class DataType> void TimeQuad_FFT_to_Hist2D<float, BinType, DataType>::checks() {
...
template <class BinType, class DataType>
Multi_array<float, 2, uint32_t> TimeQuad_FFT_to_Hist2D<float, BinType, DataType>::copy_ks(np_double &np_ks,
                                                                                          uint n_prod) {
...
template <class BinType, class DataType>
std::vector<ssize_t> TimeQuad_FFT_to_Hist2D<float, BinType, DataType>::get_shape(np_double &np_array) {
...
template <class BinType, class DataType>
void TimeQuad_FFT_to_Hist2D<float, BinType, DataType>::execute(Multi_array<DataType, 1, uint64_t> &data) {
...
template <class BinType, class DataType> void TimeQuad_FFT_to_Hist2D<float, BinType, DataType>::reset() {
...
template <class BinType, class DataType>
py::array_t<double> TimeQuad_FFT_to_Hist2D<float, BinType, DataType>::abscisse_py(double max, uint nofbins) {
