...
void TimeQuad_FFT_to_Hist2D<double, BinType, DataType>::prepare_plans() {
    ...
    kernel_plan =
        fftw_plan_dft_r2c_1d(l_fft, (double *)ks_complex(0),
                             reinterpret_cast<fftw_complex *>(ks_complex(0)), FFTW_EXHAUSTIVE);
    g_plan = fftw_plan_dft_r2c_1d(l_fft, gs[0], reinterpret_cast<fftw_complex *>(fs[0]),
                                  FFTW_EXHAUSTIVE);
    int n[] = {(int)l_fft};
...
TimeQuad_FFT_to_Hist2D<double, BinType, DataType>::copy_ks(np_double &np_ks, uint n_prod) {
...
template <class BinType, class DataType>
std::vector<ssize_t>
TimeQuad_FFT_to_Hist2D<double, BinType, DataType>::get_shape(np_double &np_array) {
...
template <class BinType, class DataType>
py::array_t<double> TimeQuad_FFT_to_Hist2D<double, BinType, DataType>::abscisse_py(double max,
                                                                                   uint nofbins) {
