...
TimeQuad_FFT_to_Hist<double, BinType, DataType>::copy_ks(np_double &np_ks, uint n_prod) {
...
template <class BinType, class DataType>
std::vector<ssize_t>
TimeQuad_FFT_to_Hist<double, BinType, DataType>::get_shape(np_double &np_array) {
...
template <class BinType, class DataType>
inline void
TimeQuad_FFT_to_Hist<double, BinType, DataType>::float_to_hist(double data, BinType *histogram,
...
template <class BinType, class DataType>
py::array_t<double> TimeQuad_FFT_to_Hist<double, BinType, DataType>::abscisse_py(double max,
                                                                                 uint nofbins) {
